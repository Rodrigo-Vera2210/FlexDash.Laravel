...
<div class="mt-2 max-w-2xl mx-auto space-y-6 page-fade">
    ...
    <div class="card-panel p-6" x-data="themePreferencesHandler()" @init="init()">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <button 
                ...
                :class="currentTheme === 'light' ? 'border-primary bg-primary-light' : 'border-border hover:border-primary'"
            ...
            <button 
                ...
                class="p-4 rounded-lg border-2 transition-all"
                :class="currentTheme === 'dark' ? 'border-primary bg-primary-light' : 'border-border hover:border-primary'"
                style="border-color: var(--border);"
            >
                <div class="flex items-center justify-center mb-3">
            ...
            <button 
                ...
                class="p-4 rounded-lg border-2 transition-all"
                :class="currentTheme === 'system' ? 'border-primary bg-primary-light' : 'border-border hover:border-primary'"
                style="border-color: var(--border);"
            >
                <div class="flex items-center justify-center mb-3">
    ...
    <div class="card-panel p-6" x-data="notificationPreferencesHandler()" @init="init()">
        ...
        <form @submit.prevent="saveNotificationPreferences" class="space-y-4">
            <div class="space-y-3">
                <div class="flex items-start gap-3 p-3 rounded-lg" style="background-color: var(--bg); border: 1px solid var(--border-light);">
                    <input 
                        type="checkbox" 
                        id="notifications_enabled" 
                        x-model="preferences.notifications_enabled"
                        class="mt-1"
                    />
                    <div class="flex-1">
                        <label for="notifications_enabled" class="text-sm font-semibold" style="color: var(--text-main);">
                ...
                <div class="flex items-start gap-3 p-3 rounded-lg" style="background-color: var(--bg); border: 1px solid var(--border-light);">
                    <input 
                        ...
                        x-model="preferences.notifications_sales"
                        :disabled="!preferences.notifications_enabled"
                        class="mt-1"
                    />
                    <div class="flex-1">
                        <label for="notifications_sales" class="text-sm font-semibold" style="color: var(--text-main);">
                ...
                <div class="flex items-start gap-3 p-3 rounded-lg" style="background-color: var(--bg); border: 1px solid var(--border-light);">
                    <input 
                        type="checkbox" 
                        id="notifications_security"
                        x-model="preferences.notifications_security"
                        :disabled="!preferences.notifications_enabled"
                        class="mt-1"
                    />
                    <div class="flex-1">
                        <label for="notifications_security" class="text-sm font-semibold" style="color: var(--text-main);">
