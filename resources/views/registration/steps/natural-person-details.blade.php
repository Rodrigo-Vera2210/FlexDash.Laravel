<form action="{{ route('registration.entity') }}" method="POST" novalidate>
    ...
    <h2 class="text-xl font-bold text-gray-800 dark:text-slate-200 mb-1">Detalles Personales</h2>
    ...
    <div class="space-y-5">
        ...
        <div>
            <label for="full_name"
                class="block text-sm font-medium dark:text-slate-400  text-gray-700 dark:text-slate-400  mb-1">
        ...
        {{-- ID Number --}}
        <div>
            <label for="id_number" class="block text-sm font-medium text-gray-700 dark:text-slate-400  mb-1">
        ...
        {{-- Address --}}
        <div>
            <label for="address" class="block text-sm font-medium text-gray-700 dark:text-slate-400  mb-1">
