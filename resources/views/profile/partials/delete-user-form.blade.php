<section class="space-y-4" x-data="{ open: {{ $errors->userDeletion->isNotEmpty() ? 'true' : 'false' }} }">
    ...
    <div class="fixed inset-0 flex items-center justify-center z-50"
        style="background-color: rgba(13,30,54,0.65); backdrop-filter: blur(4px); display: none;" x-show="open"
        ...
        <div class="card-panel w-full max-w-md overflow-hidden p-0" style="border-radius: 20px;">
            ...
            <div class="flex items-center justify-between px-6 py-5"
                ...
                <div class="flex items-center gap-3">
                    <div
                        class="w-9 h-9 rounded-xl flex items-center justify-center bg-[color:var(--danger-light)] text-[color:var(--danger)]">
            ...
            <form method="post" action="{{ route('profile.destroy') }}" class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <input id="password" name="password" type="password" class="input-solid"
