...
<div class="mt-2 max-w-lg mx-auto page-fade">
    <div class="card-panel p-6">
        ...
        <div class="flex items-center gap-3 mb-6 pb-4 border-b border-[color:var(--border-light)]">
            <div class="w-10 h-10 rounded-xl flex items-center justify-center bg-[color:var(--primary-light)] text-[color:var(--primary)]">
        ...
        <form method="POST" action="{{ route('password.change.submit') }}" class="space-y-4">
            ...
            <div>
                ...
                <input
                    ...
                    class="input-solid mt-1 {{ $errors->has('current_password') ? 'border-red-500' : '' }}"
            ...
            <div>
                ...
                <input
                    ...
                    id="new_password"
                    name="new_password"
                    class="input-solid mt-1 {{ $errors->has('new_password') ? 'border-red-500' : '' }}"
