    ...
    <div class="mt-2 max-w-md mx-auto page-fade">
        <div class="card-panel p-6 text-center">
            ...
            <div class="flex justify-center mb-5">
                <span
                    class="flex items-center justify-center w-16 h-16 rounded-full bg-[color:var(--primary-light)] text-[color:var(--primary)]">
            ...
            <p class="text-sm mb-1 text-[color:var(--text-secondary)]">Enviamos un código de verificación de 6 dígitos a:
            </p>
            ...
            <div class="border-t border-[color:var(--border-light)] pt-4 mt-2">
                ...
                <div class="mt-3">
                    <a href="{{ route('password.change') }}"
                        class="text-sm text-[color:var(--text-tertiary)] hover:underline">
